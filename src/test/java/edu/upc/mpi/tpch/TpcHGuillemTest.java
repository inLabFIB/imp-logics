...
public class TpcHGuillemTest {
    ...
    @Test @Ignore
    public void test(){
        File tpcFile = new File("src\\test\\resources\\tpc-h-guillem.txt");
    ...
    private void checkNormalizedConstraints(LogicSchema schema) {
        ...
        assertEquals(null, schema.getConstraintByNumber(400004));
        ...
        assertEquals(null, schema.getConstraintByNumber(400101));
    }
