...
public class SchemaTraceabilityMap {
     ...
     * <p>
     * In particular, the new map will contain the finalConstraintIDs of the first map given
     * pointing to the originalConstraintIDs of the last map given.
     * <p>
     * E.g.: first map might be {A2 -> A1}, whereas the second might be {A1 -> A0} so that
     * the final result will be {A2 -> A0}.
     *
     * @param maps not-null
    ...
    /**
     * This method builds a new SchemaTraceabilityMap containing the constraints of the current map
     * pointing to the original constraintIDs of this map
     * <p>
     * In particular, the method joins the original constraintID of the current map, with the final
     * constraintID of this map.
     * <p>
     * E.g.: if the current SchemaTraceabilityMap contains the mapping F1 -> O1
     * and this SchemaTraceabilityMap contains the mapping O1 -> OO1
     * the resulting map will contain F1 -> OO1
     *
