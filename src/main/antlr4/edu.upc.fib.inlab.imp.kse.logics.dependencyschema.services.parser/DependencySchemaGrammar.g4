...
@lexer::members {
private edu.upc.fib.inlab.imp.kse.logics.logicschema.services.parser.CustomBuiltInPredicateNameChecker builtInPredicateNameChecker = new edu.upc.fib.inlab.imp.kse.logics.logicschema.services.parser.CustomBuiltInPredicateNameChecker(java.util.Set.of());

public DependencySchemaGrammarLexer(CharStream input, edu.upc.fib.inlab.imp.kse.logics.logicschema.services.parser.CustomBuiltInPredicateNameChecker builtInPredicateNameChecker) {
    this(input);
