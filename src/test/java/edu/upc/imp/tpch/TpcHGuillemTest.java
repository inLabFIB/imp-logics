package edu.upc.imp.tpch;

import edu.upc.imp.augmented_logicschema.LogicSchemaAugmenter;
import edu.upc.imp.logicschema.DerivationRule;
import edu.upc.imp.logicschema.LogicConstraint;
import edu.upc.imp.logicschema.LogicSchema;
import edu.upc.imp.logicschema_normalizer.LogicSchemaNormalizer;
...
public class TpcHGuillemTest {
    ...
    public void test() throws URISyntaxException {
        File tpchSchemaFile = new File(ClassLoader.getSystemResource("tpc-h-guillem.txt").toURI());
        File tpchAugmentedSchemaFile = new File(ClassLoader.getSystemResource("tpc-h-guillem_augmented.txt").toURI());
        File tpchNormalizedSchemaFile = new File(ClassLoader.getSystemResource("tpc-h-guillem_normalized.txt").toURI());
