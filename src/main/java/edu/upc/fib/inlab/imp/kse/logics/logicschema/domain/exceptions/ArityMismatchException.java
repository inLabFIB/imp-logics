...
/**
 * Thrown to indicate that the quantity of Term (arity) of an object does not match expected. This could be the case
 * for the classes {@code Atom}, {@code Predicate} or instances of {@code Literal}.
 */
